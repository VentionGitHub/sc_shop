...
func main() {
	dsn := "123456@tcp(127.0.0.1:3306)/goods_test?charset=utf8mb4&parseTime=True&loc=Local"
...
func Mysql2Es() {
	dsn := "123456@tcp(127.0.0.1:3306)/mxshop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
